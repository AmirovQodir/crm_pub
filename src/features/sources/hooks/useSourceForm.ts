...
import { FIELD_EMAIL, FIELD_NAME, FIELD_PASSWORD, FIELD_PHONE } from '../../../common/constants';
...
export const useSourceForm = () => {
  ...
  const handleSourceForm = handleSubmit(onSubmit);

  return { control, register, setValue, getValues, isLoading, handleReset, resetValues: reset, handleSourceForm, contextHolder };
};
